...
public:
    ...
    EnvironmentSample sample_environment(const math::Vector3& direction, const media::HDRTextureData* environment_map, float intensity, float rotation);
    EnvironmentSample sample_environment(const math::Vector3& direction, const media::HDRTextureData* environment_map, float intensity, float rotation, float roughness);
