...
/**
 * @brief A keyframe for spatial paths (position, POI, anchor point).
 */
...
/**
 * @brief Interpolator for spatial paths.
 * 
 * Unlike scalar interpolation, spatial interpolation uses cubic-hermite splines
 * for smooth "curved" paths in the viewport.
 */
class SpatialInterpolator {
public:
    /**
     * @brief Evaluate a position at time t.
     */
    ...
    /**
     * @brief Generate a list of points representing the path for visualization.
     */
