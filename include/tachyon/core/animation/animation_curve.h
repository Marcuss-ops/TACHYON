...
struct LerpTraits<ColorSpec> {
    [[nodiscard]] static ColorSpec lerp(const ColorSpec& a, const ColorSpec& b, double t) {
...
[[nodiscard]] inline ColorSpec hermite_interp(const Keyframe<ColorSpec>& k0, const Keyframe<ColorSpec>& k1, double t) {
