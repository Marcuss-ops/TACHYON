...
[[nodiscard]] inline LayerSpec build_minimal(
    ...
    text.enabled = true;
    text.visible = true;
    text.timing.start = opts.start_time;
    text.timing.duration = opts.duration;
    text.width = opts.width;
    text.height = opts.height;
    text.text.content = opts.text;
    text.text.font_id = opts.font_id;
    text.text.font_size = opts.font_size;
    text.text.fill_color = AnimatedColorSpec(opts.fill_color);
...
[[nodiscard]] inline LayerSpec build_typewriter(
    ...
    text.text.font_size = opts.font_size;
    text.text.fill_color = AnimatedColorSpec(opts.fill_color);
    text.text.box.fixed_pitch = true;
    text.transform.position_x = static_cast<double>(opts.position_x);
    text.transform.position_y = static_cast<double>(opts.position_y);
