...
Owner: Core Team
Supersedes: Legacy inline CLAUDE.md rules
---

# Tachyon Presets Contract
...
`include/tachyon/text/animation/text_presets.h` contiene i 20 `make_*_animator()` che restituiscono `TextAnimatorSpec`. Sono **primitivi interni** — non vanno usati direttamente dall'utente finale, solo dai builder in `src/presets/text/text_builders.cpp`.
