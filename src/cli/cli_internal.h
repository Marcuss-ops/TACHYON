...
bool run_doctor_command(const CliOptions& options, std::ostream& out, std::ostream& err, runtime::RuntimeRegistryBundle& bundle);
...
bool run_preview_internal(const CliOptions& options, std::ostream& out, std::ostream& err, const char* label, runtime::RuntimeRegistryBundle& bundle);
