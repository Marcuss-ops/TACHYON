...
void ScenePresetRegistry::load_builtins() {
    register_spec({
        ...
        {"tachyon.scene.enhanced_text", "Modern Aura", "Clean animated text with modern styling.", "scene.built-in", {"text", "modern"}, 1, registry::Stability::Stable, {}},
        {},
    ...
    register_spec({
        ...
        {"tachyon.scene.modern_grid", "Modern Tech Grid", "High-tech grid background with floating elements.", "scene.built-in", {"grid", "tech"}, 1, registry::Stability::Stable, {}},
        {},
    ...
    register_spec({
        ...
        {"tachyon.scene.classico_premium", "Classico Premium", "Elegant premium presentation style.", "scene.built-in", {"premium", "elegant"}, 1, registry::Stability::Stable, {}},
        {},
    ...
    register_spec({
        ...
        {"tachyon.scene.minimal_text", "Minimal White", "Simple minimal white background with bold text.", "scene.built-in", {"minimal", "white"}, 1, registry::Stability::Stable, {}},
        {},
    ...
    register_spec({
        "tachyon.scene.b",
        {"tachyon.scene.b", "Scene B", "Red background with centered text.", "scene.built-in", {"red", "test"}, 1, registry::Stability::Stable, {}},
        {},
