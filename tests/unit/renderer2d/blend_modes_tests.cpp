...
bool run_blend_modes_tests() {
    {
        const tachyon::renderer2d::Color src{255, 255, 255, 255};
        const tachyon::renderer2d::Color dst{64, 128, 192, 255};
        ...
        check_true(pixel.a == 255, "overlay blend should preserve opaque alpha");
    }

    {
        ...
        check_true(pixel.a == 255, "soft light should preserve opaque alpha");
    }
