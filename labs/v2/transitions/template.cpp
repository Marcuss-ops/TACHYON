...
extern "C" __declspec(dllexport) void build_scene(tachyon::SceneSpec& scene) {
    ...
    // --- SCENE B (Front, Transitions In) ---
    {
        ...
        l.transition_in.transition_id = "TRANS_ID";
        l.transition_in.type = "TRANS_ID";
    ...
    comp.layer("label", [&](LayerBuilder& l) {
        l.text().content("TRANS_NAME").font("SFPro").font_size(80).box(1920, 150).align(HorizontalAlign::Center).done()
