 ...
 */
class PlaybackScheduler : public IPlaybackScheduler {
public:
    enum class Priority {
    ...
    PlaybackScheduler(IMediaProvider& manager, std::size_t thread_count = 4) 
    ...
    void schedule_task(Task task) override {
        {
