# TACHYON Engine Operations Map

Reference document for the TACHYON C++ operations.

Goal:
- map the engine functionality by functional area;
- separate real operations from validators, builders, and placeholders;
- highlight what is missing or only partially implemented.

## 1. General Overview

The engine exposes 7 main areas:
